...
hero_image: './S3와_CloudFront_히어로_이미지.jpeg'
...
<MDXImageWrapper caption="S3 버킷 생성하기 - 모든 퍼블릭 액세스 차단">
  ![S3 버킷 생성하기 - 모든 퍼블릭 액세스 차단](./S3_버킷_생성하기-모든_퍼블릭_엑세스_차단.png)
</MDXImageWrapper>
...
<MDXImageWrapper caption="정적 웹 사이트 호스팅 편집 예시">
  ![정적 웹 사이트 호스팅 편집 예시](./정적_웹_사이트_호스팅_편집_예시.png)
</MDXImageWrapper>
...
<MDXImageWrapper caption="기본값 루트 객체 설정 예시">
  ![기본값 루트 객체 설정 예시](./기본값_루트_객체_설정_예시.png)
</MDXImageWrapper>
...
<MDXImageWrapper caption="사용자 정의 오류 응답 예시">
  ![사용자 정의 오류 응답 예시](./사용자_정의_오류_응답_예시.png)
</MDXImageWrapper>
