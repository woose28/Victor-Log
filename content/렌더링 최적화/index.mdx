...
tags: ['Performance']
hero_image: './렌더링_최적화_히어로_이미지.jpeg'
...
<MDXImageWrapper style={{ maxWidth: '100%' }} caption="마지막 커밋 단계에서도 이전 페이지의 ChallengeItem이 렌더링 됨">
  ![마지막 커밋 단계에서도 이전 페이지의 ChallengeItem이 렌더링 됨](./마지막_커밋_단계에서도_이전_페이지의_ChallengeItem이_렌더링_됨.png)
</MDXImageWrapper>
...
<MDXImageWrapper style={{ maxWidth: '100%' }} caption="마지막 커밋 단계에서 이전 페이지의 ChallengeItem이 렌더링 안됨">
  ![마지막 커밋 단계에서 이전 페이지의 ChallengeItem이 렌더링 안됨](./마지막_커밋_단계에서_이전_페이지의_ChallengeItem이_렌더링_안됨.png)
</MDXImageWrapper>
