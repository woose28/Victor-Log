...
tags: ['Performance']
hero_image: './[스모디프로젝트]_성능_리포트_히어로_이미지.jpeg'
...
<MDXImageWrapper style={{ maxWidth: '100%' }} caption="Lighthouse 측정 환경">
  ![Lighthouse 측정 환경](./Lighthouse_측정_환경.png)
</MDXImageWrapper>
...
<MDXImageWrapper style={{ maxWidth: '100%' }} caption="데스크탑 성능 개선 전 Lighthouse 점수">
  ![데스크탑 성능 개선 전 Lighthouse 점수](./데스크탑_성능_개선_전_Lighthouse_점수.png)
</MDXImageWrapper>
...
<MDXImageWrapper style={{ maxWidth: '100%' }} caption="데스크탑 성능 개선 후 Lighthouse 점수">
  ![데스크탑 성능 개선 후 Lighthouse 점수](./데스크탑_성능_개선_후_Lighthouse_점수.png)
</MDXImageWrapper>
...
<MDXImageWrapper style={{ maxWidth: '100%' }} caption="모바일 성능 개선 전 Lighthouse 점수">
  ![모바일 성능 개선 전 Lighthouse 점수](./모바일_성능_개선_전_Lighthouse_점수.png)
</MDXImageWrapper>
...
<MDXImageWrapper style={{ maxWidth: '100%' }} caption="모바일 성능 개선 후 Lighthouse 점수">
  ![모바일 성능 개선 후 Lighthouse 점수](./모바일_성능_개선_후_Lighthouse_점수.png)
</MDXImageWrapper>
...
<MDXImageWrapper style={{ maxWidth: '100%' }} caption="코드 스플리팅 적용 전">
  ![코드 스플리팅 적용 전](./코드_스플리팅_적용_전.png)
</MDXImageWrapper>

**변경 후**

<MDXImageWrapper style={{ maxWidth: '100%' }} caption="코드 스플리팅 적용 후">
  ![코드 스플리팅 적용 후](./코드_스플리팅_적용_후.png)
</MDXImageWrapper>
...
<MDXImageWrapper style={{ maxWidth: '100%' }} caption="검색 페이지 최적화 전 - 마지막 커밋 단계에서도 이전 페이지의 ChallengeItem이 렌더링 됨">
  ![검색 페이지 최적화 전 - 마지막 커밋 단계에서도 이전 페이지의 ChallengeItem이 렌더링 됨](./검색_페이지_최적화_전_-_마지막_커밋_단계에서도_이전_페이지의_ChallengeItem이_렌더링_됨.png)
</MDXImageWrapper>
...
<MDXImageWrapper style={{ maxWidth: '100%' }} caption="검색 페이지 최적화 후 - 마지막 커밋 단계에서도 이전 페이지의 ChallengeItem이 렌더링 안됨">
  ![검색 페이지 최적화 후 - 마지막 커밋 단계에서도 이전 페이지의 ChallengeItem이 렌더링 안됨](./검색_페이지_최적화_후_-_마지막_커밋_단계에서도_이전_페이지의_ChallengeItem이_렌더링_안됨.png)
</MDXImageWrapper>
...
<MDXImageWrapper style={{ maxWidth: '100%' }} caption="피드 페이지 최적화 전 - 초기 이미지 요청 개수: 20개">
  ![피드 페이지 최적화 전 - 초기 이미지 요청 개수: 20개](./피드_페이지_최적화_전_-_초기_이미지_요청_개수:_20개.png)
</MDXImageWrapper>
...
<MDXImageWrapper style={{ maxWidth: '100%' }} caption="피드 페이지 최적화 후 - 초기 이미지 요청 개수: 11개">
  ![피드 페이지 최적화 후 - 초기 이미지 요청 개수: 11개](./피드_페이지_최적화_후_-_초기_이미지_요청_개수:_11개.png)
</MDXImageWrapper>
...
<MDXImageWrapper style={{ maxWidth: '100%' }} caption="큰 이미지에 lazy loading 적용 시 LCP 증가에 대한 경고">
  ![큰 이미지에 lazy loading 적용 시 LCP 증가에 대한 경고](./큰_이미지에_lazy_loading_적용_시_LCP_증가에_대한_경고.png)
</MDXImageWrapper>
