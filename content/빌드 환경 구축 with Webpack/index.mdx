...
hero_image: './빌드_환경_구축_with_Webpack_히어로_이미지.jpeg'
...
<MDXImageWrapper caption="source-map 있는 경우 코드">
  ![source-map 있는 경우 코드](./source-map_있는_경우_코드.png)
</MDXImageWrapper>
...
<MDXImageWrapper caption="source-map 없는 경우 코드">
  ![source-map 없는 경우 코드](./source-map_없는_경우_코드.png)
</MDXImageWrapper>
...
<MDXImageWrapper caption="source-map 사용 예시">
  ![source-map 사용 예시](./source-map_사용_예시.png)
</MDXImageWrapper>
...
<MDXImageWrapper caption="eval-cheap-module-source-map 사용 예시">
  ![eval-cheap-module-source-map 사용 예시](./eval-cheap-module-source-map_사용_예시.png)
</MDXImageWrapper>
...
<MDXImageWrapper caption="splitChunk 적용 전 gzip">
  ![splitChunk 적용 전 gzip](./splitChunk_전_gzip.png)
</MDXImageWrapper>
...
<MDXImageWrapper caption="splitChunk 적용 후 gzip">
  ![splitChunk 적용 후 gzip](./splitChunk_후_gzip.png)
</MDXImageWrapper>
