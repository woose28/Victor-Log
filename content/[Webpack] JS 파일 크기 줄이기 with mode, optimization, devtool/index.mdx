...
hero_image: './[Webpack]_JS_파일_크기_줄이기_with_mode,_optimization,_devtool.jpeg'
...
<MDXImageWrapper caption="개발 모드로 빌드 했을 때">
  ![개발 모드로 빌드 했을 때](./개발_모드로_빌드_했을_때.png)
</MDXImageWrapper>

<MDXImageWrapper caption="프로덕션 모드로 빌드 했을 때">
  ![프로덕션 모드로 빌드 했을 때](./프로덕션_모드로_빌드_했을_때.png)
</MDXImageWrapper>
...
<MDXImageWrapper caption="optimization.minimize 적용 후 bundle 크기">
  ![optimization.minimize 적용 후 bundle 크기](./optimization.minimize_적용_후_bundle_크기.png)
</MDXImageWrapper>
...
<MDXImageWrapper caption="devtool false dist 사진">
  ![devtool false dist 사진](./devtool_false_dist_사진.png)
</MDXImageWrapper>

<MDXImageWrapper caption="devtool source-map dist 사진">
  ![devtool source-map dist 사진](./devtool_source-map_dist_사진.png)
</MDXImageWrapper>
