...
tags: ['Performance']
hero_image: './웹_캐시_with_S3,_CloudFront_히어로_이미지.jpeg'
...
<MDXImageWrapper caption="Cache TTL 설정 안한 경우">
  ![Cache TTL 설정 안한 경우](./Cache_TTL_설정_안한_경우.png)
</MDXImageWrapper>
...
<MDXImageWrapper caption="S3 Cache-Control 설정">
  ![S3 Cache-Control 설정](./S3_Cache-Control_설정.png)
</MDXImageWrapper>
...
<MDXImageWrapper caption="CloudFront 캐시 정책 설정">
  ![CloudFront 캐시 정책 설정](./CloudFront_캐시_정책_설정.png)
</MDXImageWrapper>
...
<MDXImageWrapper caption="Cache TTL 짧은 경우">
  ![Cache TTL 짧은 경우](./Cache_TTL_짧은_경우.png)
</MDXImageWrapper>
